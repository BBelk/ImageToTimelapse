...
export async function estimatePoses(source) {
...
export function getDisplayRect(srcWidth, srcHeight, container) {
...
export function drawPoses(canvas, poses, displayRect, selectedIdx) {
...
export function getPoseBounds(poses, displayRect) {
...
export function drawSinglePose(ctx, keypoints, displayRect, personId, isSelected) {
  const { offsetX, offsetY, width, height } = displayRect;
  const thresh = POSE_CONFIG.confidenceThreshold;
